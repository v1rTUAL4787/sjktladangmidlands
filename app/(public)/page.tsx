    ...
    <div>
      ...
      <section className="bg-gradient-to-br from-[#1B3A6B] to-[#0f2240] text-white py-16 px-4">
        <div className="container mx-auto max-w-4xl flex flex-col md:flex-row items-center gap-8">
          ...
          <img src="https://saoqnwdydwomigkgjciz.supabase.co/storage/v1/object/public/SJKTPublic/circle%20logo1.svg" alt="School Badge" className="h-36 mix-blend-luminosity drop-shadow-lg" />
          <div>
